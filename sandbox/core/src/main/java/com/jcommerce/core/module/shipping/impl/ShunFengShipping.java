...
public class ShunFengShipping implements IShippingModule {

	private static final String name = "邮局平邮";

	PropertyReader pReader = new PropertyReader("shunFengShipping.properties", this.getClass());
	...
	public String getDefaultConfig() {
		...
		options.put("free", "0");
		field.setLable("ShunFengShipping");
		field.setOptions(options);
		return field.toString();
	}

	public String getCode() {
		return "ShunFengShipping";
	}
