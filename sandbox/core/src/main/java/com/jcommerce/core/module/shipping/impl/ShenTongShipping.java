...
public class ShenTongShipping implements IShippingModule {

	private static final String name = "申通快递";

	PropertyReader pReader = new PropertyReader("shenTongShipping.properties", this.getClass());
	...
	public String getDefaultConfig() {
		...
		options.put("free", "0");
		field.setLable("ShenTongShipping");
		field.setOptions(options);
		return field.toString();
	}

	public String getCode() {
		return "ShenTongShipping.java";
	}
