...
public class MailShipping implements IShippingModule {

   private static final String name = "邮政快递包裹";
	
   PropertyReader pReader = new PropertyReader("mailShipping.properties", this.getClass());
