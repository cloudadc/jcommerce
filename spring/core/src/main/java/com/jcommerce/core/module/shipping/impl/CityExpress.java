...
public class CityExpress implements IShippingModule {
	
	private static final String name = "城际快递";
	
	PropertyReader pReader = new PropertyReader("cityExpress.properties", this.getClass());
