...
public class MagazineManager extends ContentWidget {
	...
	private native void initJS(MagazineManager me) /*-{
	   $wnd.deleteMagazine = function (id) {
	       me.@com.jcommerce.gwt.client.panels.email.MagazineManager::deleteMagazineAndRefresh(Ljava/lang/String;)(id);
	   };
	   $wnd.insertMagazine = function (id) {
	       me.@com.jcommerce.gwt.client.panels.email.MagazineManager::insertMagazine(Ljava/lang/String;)(id);
	   };
	   $wnd.editMagazine = function (id) {
	       me.@com.jcommerce.gwt.client.panels.email.MagazineManager::editMagazine(Ljava/lang/String;)(id);
	   };
	   }-*/;
