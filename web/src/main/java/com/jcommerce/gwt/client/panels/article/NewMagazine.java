...
import com.jcommerce.gwt.client.panels.article.MagazineManager.State;
...
//	}
	...
	protected void onRender(Element parent, int index) {
		...
		contentPanel.createPanel(IMailTemplate.SUBJECT, "杂志标题", title);
		contentPanel.createPanel(IMailTemplate.CONTENT, "杂志内容", tabPanel);
