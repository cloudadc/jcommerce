...
public class UserRankReport extends ContentWidget {
	...
	public static class State extends PageState {
		public String getPageClassName() {
			return UserRankReport.class.getName();
		}
	...
	protected void onRender(Element parent, int index) {
        ...
        button.addListener(Events.Select, new Listener<ComponentEvent>() {
            public void handleEvent(ComponentEvent be) {
                ...
                new ReportService().generateReport("UserRankReport", params, new ReportService.Listener() {
                    @Override
