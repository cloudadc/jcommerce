...
public class PostShipping implements IShippingModule {

	private static final String name = "邮局平邮";

	PropertyReader pReader = new PropertyReader("postShipping.properties", this.getClass());
