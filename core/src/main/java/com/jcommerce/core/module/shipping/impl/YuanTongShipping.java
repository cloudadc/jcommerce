...
public class YuanTongShipping implements IShippingModule {
	private static final String name = "圆通速递";

	PropertyReader pReader = new PropertyReader("yuanTongShipping.properties", this.getClass());
	...
	public String getDefaultConfig() {
		...
		options.put("free", "0");
		field.setLable("YuanTongShipping");
		field.setOptions(options);
		return field.toString();
	}

	public String getCode() {
		return "YuanTongShipping";
	}
